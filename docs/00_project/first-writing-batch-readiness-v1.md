...
2. 회차당 분량: 하한 약 5,500자(`[ASSUMPTION]` 공백 포함), **상한 없음**(작가 판정 2026-08-12, [[decision-log]] D-20260812-01 — 진단 범위 5,500~6,500자 폐지). 따라서 2차 패스는 분량 축소가 아니라 밀도·반복 정리(미래기억 밀도, E14/E18 반복, 청문 장면 길이)로 수행 — E1~5 감사의 삭제 금지 목록 유지 확인 포함.
