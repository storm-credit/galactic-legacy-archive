# GA5 E451–E570 Writer-Activation Context Overlay v1
...
Rian close third, with Maren/Vesper traffic reports.
...
**SCENE_CAUSAL_CHAIN**  
PRESSURE[dock the Outer Meridian/Ardis route group and obtain fuel, food, medical and repair access without accepting a hidden fleet command transfer.] → OBSTACLE[every berth, hose, key and payroll queue is attached to a different authority; one “fleet assembly” order would silently rank those claims.] → PIVOT[Rian refuses Dor-aligned staff’s offer to designate all nearby route ships as his provisional fleet and requests a 72-hour service/defense fact board instead.] → DELTA[current ship/crew claims become visible; `파루스` receives minimum safe dock service.] → COST[Rian gains no ammunition or broad command; several officers publicly call the route coalition indecisive.] → NEXT[Vesper workers activate a physical red stop on Fuel Spine 4 while three armed formations demand reopening.]

**HUMAN_PRESSURE_CARRIER**  
source POV/current participants: Rian close third, with Maren/Vesper traffic reports.
...
**POV_INFORMATION_ROUTE**  
depot operator Ilya Fen, Tav Oren and Nera.
**POV_ROUTE_AUTHORITY:** `SOURCE-EXPLICIT`
...
**SCENE_CAUSAL_CHAIN**  
PRESSURE[determine whether the Fuel Spine 4 stop is sabotage, labor pressure or a valid safety action.] → OBSTACLE[reopening immediately would fuel 17 ships; continued closure begins oxygen/medical transport rationing within 31 hours.] → PIVOT[preserve the physical stop and ration flow rather than use military force or full remote override.] → DELTA[catastrophic fracture avoided; emergency minimum services continue.] → COST[combat refueling queues lengthen 18–29 hours; one Protector patrol misses its preferred departure window.] → NEXT[payroll authentication for 38,600 depot and fleet workers expires during the reduced-flow period.]

**HUMAN_PRESSURE_CARRIER**  
source POV/current participants: depot operator Ilya Fen, Tav Oren and Nera.
**HUMAN_ROUTE_AUTHORITY:** `SOURCE-POV`
...
**POV_INFORMATION_ROUTE**  
Haren, Messa Rin, Kev Raon and civil-pay staff.
**POV_ROUTE_AUTHORITY:** `SOURCE-EXPLICIT`
...
**SCENE_CAUSAL_CHAIN**  
PRESSURE[keep earned wages/family allotments moving without forcing crews to recognize one claimant or command chain.] → OBSTACLE[the Treasury can pay most registered crews quickly if they accept a broad civil-continuity certification that several ships treat as political allegiance.] → PIVOT[issue 14-day emergency earned-pay/family support through multiple contributors and publish who remains excluded.] → DELTA[52,760 of 61,400 records receive current payment or family-support authorization.] → COST[8,640 remain in alternate/review paths; Treasury/provinces assume debt that has no final allocation.] → NEXT[`세 번째 종` crew locks its bridge and ammunition handling after receiving three authentic orders.]

**HUMAN_PRESSURE_CARRIER**  
source POV/current participants: Haren, Messa Rin, Kev Raon and civil-pay staff.
**HUMAN_ROUTE_AUTHORITY:** `SOURCE-POV`
...
**POV_INFORMATION_ROUTE**  
Captain Rami Ode, Kev Raon, Maren and Rian.
**POV_ROUTE_AUTHORITY:** `SOURCE-EXPLICIT`
...
**SCENE_CAUSAL_CHAIN**  
PRESSURE[prevent armed boarding or uncontrolled departure of `세 번째 종`.] → OBSTACLE[the captain, crew, province and Protector all possess real but incomplete authority; seizing the bridge would create the exact inherited-fleet precedent GA4 rejected.] → PIVOT[establish a 36-hour nonboarding/nondeparture standstill with internal safety authority preserved and weapons sealed.] → DELTA[no mutiny massacre or forced seizure; negotiations gain time.] → COST[one R3-capable destroyer remains unavailable and two escorts divert to watch it.] → NEXT[depot ammunition workers report that another formation is moving loaders toward a magazine under an emergency requisition.]

**HUMAN_PRESSURE_CARRIER**  
source POV/current participants: Captain Rami Ode, Kev Raon, Maren and Rian.
**HUMAN_ROUTE_AUTHORITY:** `SOURCE-POV`
...
**POV_INFORMATION_ROUTE**  
Ardo Rev, Tav, depot workers and Oren Roman.
**POV_ROUTE_AUTHORITY:** `SOURCE-EXPLICIT`

**PRIMARY_DECISION_OWNER**  
source decision performer/authority actor(s): Ardo
**OWNER_ROUTE_AUTHORITY:** `SOURCE-DECISION-PERFORMER + SOURCE DECISION`
...
**SCENE_CAUSAL_CHAIN**  
PRESSURE[stop an armed magazine confrontation while preserving enough ammunition for actual defense.] → OBSTACLE[Ardo’s requisition would create the fastest coherent defensive load; yard/workers know several missile lots have incompatible guidance certificates.] → PIVOT[Ardo accepts a smaller immediately safe issue rather than seize the full magazine, while recording that the delay may cost lives.] → DELTA[13 ships receive enough countermeasure/ammunition for one bounded defense mission.] → COST[Legion Vanguard receives only 62% of its requested immediate issue; central-command supporters gain a credible complaint.] → NEXT[an unmarked probe group tests Vesper outer sensors while the depot still lacks a common defensive intent.]

**HUMAN_PRESSURE_CARRIER**  
source POV/current participants: Ardo Rev, Tav, depot workers and Oren Roman.
**HUMAN_ROUTE_AUTHORITY:** `SOURCE-POV`
...
**POV_INFORMATION_ROUTE**  
Sira Keon, Oren, local civil services and route representatives.
**POV_ROUTE_AUTHORITY:** `SOURCE-EXPLICIT`
...
**SCENE_CAUSAL_CHAIN**  
PRESSURE[define what a short shared mandate protects before the probe becomes an attack.] → OBSTACLE[“defend Vesper” could mean depot stores, Crown Passage, Talren civilians, provincial return routes or pursuit of the probe; no force can cover all.] → PIVOT[publish a shared intent with four priorities: inhabited rescue, depot minimum service, Talren/Crown civilian corridors and no unilateral asset seizure.] → DELTA[ships can compare orders against named objectives instead of personalities.] → COST[Outer Front pursuit and several provincial home routes receive no guaranteed coverage.] → NEXT[one participant demands the mandate name a single commander with default authority when communications fail.]

**HUMAN_PRESSURE_CARRIER**  
source POV/current participants: Sira Keon, Oren, local civil services and route representatives.
**HUMAN_ROUTE_AUTHORITY:** `SOURCE-POV`
...
**POV_INFORMATION_ROUTE**  
mandate board, ship captains and current workers.
**POV_ROUTE_AUTHORITY:** `SOURCE-EXPLICIT`
...
**SCENE_CAUSAL_CHAIN**  
PRESSURE[enact a reproducible 7-day defense/service mandate before the probes return.] → OBSTACLE[a default commander would be faster, but title/pay/keys/physical stops could follow mission command by practice.] → PIVOT[leave no universal default commander; ships use standing intent and current formation succession under communications loss.] → DELTA[`Vesper Shared Defense & Service Mandate` becomes operational.] → COST[only a fraction of nearby force participates; response will be slower than unified command.] → NEXT[`세 번째 종` must decide whether it can join without surrendering crew, captain, province and safety claims.]

**HUMAN_PRESSURE_CARRIER**  
source POV/current participants: mandate board, ship captains and current workers.
**HUMAN_ROUTE_AUTHORITY:** `SOURCE-POV`
...
**POV_INFORMATION_ROUTE**  
Kev Raon, Captain Rami Ode and current watch sections.
**POV_ROUTE_AUTHORITY:** `SOURCE-EXPLICIT`
...
**SCENE_CAUSAL_CHAIN**  
PRESSURE[identify what the ship’s people actually promised before deciding which order they can obey.] → OBSTACLE[officers, enlisted crew, technical contractors and frame personnel use different oath texts and family/pay systems.] → PIVOT[negotiate a mission agreement by authority layer rather than hold a single loyalty vote.] → DELTA[each cohort’s standing and nontransferable rights become visible.] → COST[the ship remains unavailable; public rumor mislabels the process as mutiny referendum.] → NEXT[Chief Engineer Leda Voss fails one of the two thermal safeties during a live low-load test.]

**HUMAN_PRESSURE_CARRIER**  
source POV/current participants: Kev Raon, Captain Rami Ode and current watch sections.
**HUMAN_ROUTE_AUTHORITY:** `SOURCE-POV`
...
**POV_INFORMATION_ROUTE**  
Leda, Tav Oren, Nera and engineering watches.
**POV_ROUTE_AUTHORITY:** `SOURCE-EXPLICIT`
...
**SCENE_CAUSAL_CHAIN**  
PRESSURE[determine whether the destroyer can deploy before certified replacement parts arrive.] → OBSTACLE[open-service replacements can restore limited function, but Helios certification and insurance do not cover sustained missile/thermal load.] → PIVOT[reduce the ship’s accepted combat envelope rather than cannibalize a provincial escort or hide the uncertainty.] → DELTA[safe propulsion, point defense and limited missile/flight capacity become available.] → COST[sustained pursuit and heavy-barrage roles are prohibited; Helios retains later certification claim.] → NEXT[48 people file incompatible requests to transfer, stand down or remain under conditions.]

**HUMAN_PRESSURE_CARRIER**  
source POV/current participants: Leda, Tav Oren, Nera and engineering watches.
**HUMAN_ROUTE_AUTHORITY:** `SOURCE-POV`
...
**POV_INFORMATION_ROUTE**  
Messa Rin, Kev, Rami, affected officers/crew and family-service staff.
**POV_ROUTE_AUTHORITY:** `SOURCE-EXPLICIT`
...
**SCENE_CAUSAL_CHAIN**  
PRESSURE[process departures and objections without stripping the ship or coercing political loyalty.] → OBSTACLE[allowing every immediate departure would make the urgent mission impossible; forcing everyone to remain treats crew as inherited property.] → PIVOT[approve staged transfer/stand-down for 48 people while requiring safe replacement and accountability for two safety cases.] → DELTA[11 officers transfer/stand down; 23 enlisted/technical crew transfer after handover; 8 people receive medical/family emergency release … [source continues]] → COST[active complement falls from 412 to 364 for the mission; watch/fatigue burden rises.] → NEXT[the home province offers immediate family support if the ship accepts its return order in full.]

**HUMAN_PRESSURE_CARRIER**  
source POV/current participants: Messa Rin, Kev, Rami, affected officers/crew and family-service staff.
**HUMAN_ROUTE_AUTHORITY:** `SOURCE-POV`
...
**POV_INFORMATION_ROUTE**  
Kev, Haren and households in two provincial systems.
**POV_ROUTE_AUTHORITY:** `SOURCE-EXPLICIT`
...
**SCENE_CAUSAL_CHAIN**  
PRESSURE[secure family allotments without allowing a province to purchase command of the whole ship.] → OBSTACLE[126 households face rent, care or food interruption within 20 days; abstract constitutional purity will not solve it.] → PIVOT[accept province funding only as a current family obligation and recorded mission contribution, not a command purchase.] → DELTA[111 of 126 urgent households gain 30-day protection; 15 enter individualized appeal/alternate support.] → COST[the province records a quantified future service/return claim; other ships demand equal treatment.] → NEXT[Dor offers Rami a direct Protector recommission that would unlock ammunition immediately.]

**HUMAN_PRESSURE_CARRIER**  
source POV/current participants: Kev, Haren and households in two provincial systems.
**HUMAN_ROUTE_AUTHORITY:** `SOURCE-POV`
...
**SCENE_CAUSAL_CHAIN**  
PRESSURE[decide whether a direct Protector recommission solves the command/authentication conflict.] → OBSTACLE[recommission would be lawful and fast inside the military domain, but crew/province/maintenance and civil mission claims would remain.] → PIVOT[separate military tactical commission from ship mission acceptance and other authority layers.] → DELTA[a lawful combat succession chain exists if Rami is incapacitated.] → COST[Dor gains a legitimate foothold and review claim; crew distrust does not disappear.] → NEXT[ammunition keys authenticate under Dor, but one crew oath field still blocks mission release.]

**HUMAN_PRESSURE_CARRIER**  
source POV/current participants: Rami, Ardo Rev and Rian.
**HUMAN_ROUTE_AUTHORITY:** `SOURCE-POV`
...
**POV_INFORMATION_ROUTE**  
Kev, weapons crews, Serin and Messa.
**POV_ROUTE_AUTHORITY:** `SOURCE-EXPLICIT`
...
**SCENE_CAUSAL_CHAIN**  
PRESSURE[design crew refusal/representation without making tactical fire a shipwide vote.] → OBSTACLE[commanders fear paralysis; crews fear political or prohibited orders.] → PIVOT[create bounded refusal and audit rules rather than unanimity or total captain discretion.] → DELTA[the crew oath block clears for defined missions.] → COST[disputed cases will still be judged after risk has been taken; two sections record formal dissent.] → NEXT[all pieces are ready except how the three authentic orders rank after the seven-day mandate expires.]

**HUMAN_PRESSURE_CARRIER**  
source POV/current participants: Kev, weapons crews, Serin and Messa.
**HUMAN_ROUTE_AUTHORITY:** `SOURCE-POV`
...
**POV_INFORMATION_ROUTE**  
Rami, Kev, Messa, Sira, Ardo and shipboard signatories.
**POV_ROUTE_AUTHORITY:** `SOURCE-EXPLICIT`
...
**SCENE_CAUSAL_CHAIN**  
PRESSURE[enact a ship-specific agreement that permits urgent defense without settling title, sovereignty or future service.] → OBSTACLE[each side wants the document to become precedent in its favor.] → PIVOT[sign the agreement without declaring who ultimately owns or permanently commands the ship.] → DELTA[`세 번째 종` joins the next bounded defense mission as the first ship-specific charter precedent.] → COST[reduced readiness, future provincial return claim, Helios certification debt and unresolved misconduct reviews.] → NEXT[before the ship completes its first joined patrol, Vesper authentication delays a real external alert.]

**HUMAN_PRESSURE_CARRIER**  
source POV/current participants: Rami, Kev, Messa, Sira, Ardo and shipboard signatories.
**HUMAN_ROUTE_AUTHORITY:** `SOURCE-POV`
...
**POV_INFORMATION_ROUTE**  
Serin, Vesper authentication staff and ship watches.
**POV_ROUTE_AUTHORITY:** `SOURCE-EXPLICIT`
...
**SCENE_CAUSAL_CHAIN**  
PRESSURE[determine whether an outer-sensor alert is real before releasing weapons and moving civilian carriers.] → OBSTACLE[the alert uses a real old sensor lineage but reaches ships through mismatched Dor, Isa, provincial and local confirmation paths.] → PIVOT[activate local defensive maneuver and rescue preparation before full common weapons authorization.] → DELTA[civilian carriers begin separation and pressure-safe movement.] → COST[combat screen remains fragmented for nine additional minutes; raiders enter the outer pump lane.] → NEXT[a forged-looking but physically accurate target update sends two ships toward the wrong fuel cluster.]

**HUMAN_PRESSURE_CARRIER**  
source POV/current participants: Serin, Vesper authentication staff and ship watches.
**HUMAN_ROUTE_AUTHORITY:** `SOURCE-POV`
...
**POV_INFORMATION_ROUTE**  
Rian, Ardo, Sira and current route operators.
**POV_ROUTE_AUTHORITY:** `SOURCE-EXPLICIT`
...
**SCENE_CAUSAL_CHAIN**  
PRESSURE[establish one current geometry without surrendering all tactical control.] → OBSTACLE[each formation’s map ranks route, civilian and military objects differently; forcing one feed could erase local hazard data.] → PIVOT[link raw motion/time and mission boundaries while preserving local physical labels and formation commands.] → DELTA[all active ships can distinguish carriers, pumps and hostile vectors.] → COST[targeting solutions remain 6–9 seconds slower; one raider crosses into the service-structure exclusion zone.] → NEXT[a provincial corvette receives no current order after its relay is jammed.]

**HUMAN_PRESSURE_CARRIER**  
source POV/current participants: Rian, Ardo, Sira and current route operators.
**HUMAN_ROUTE_AUTHORITY:** `SOURCE-POV`
...
**POV_INFORMATION_ROUTE**  
Doan Mir aboard provincial corvette `오래된 계절`.
**POV_ROUTE_AUTHORITY:** `SOURCE-EXPLICIT`
...
**SCENE_CAUSAL_CHAIN**  
PRESSURE[prevent a disabled medical/fuel carrier from striking Pump D-9 while communications are isolated.] → OBSTACLE[the corvette’s signed orders prioritize formation screen; local standing intent prioritizes inhabited rescue and pump-cascade prevention.] → PIVOT[act under published intent without waiting for Rian, Sira or Ardo.] → DELTA[386 exposed carrier personnel survive; Pump D-9 cascade is prevented.] → COST[`오래된 계절` loses propulsion and combat capacity; casualties begin.] → NEXT[raiders exploit the gap to hit a fuel barge and medical-polymer container train.]

**HUMAN_PRESSURE_CARRIER**  
source POV/current participants: Doan Mir aboard provincial corvette `오래된 계절`.
**HUMAN_ROUTE_AUTHORITY:** `SOURCE-POV`
...
**POV_INFORMATION_ROUTE**  
Rami, Kev, weapons teams and Leda.
**POV_ROUTE_AUTHORITY:** `SOURCE-EXPLICIT`
...
**SCENE_CAUSAL_CHAIN**  
PRESSURE[use `세 번째 종` inside its bounded agreement without exceeding thermal or political mission limits.] → OBSTACLE[a sustained missile sequence could destroy the raider screen faster but violates Leda’s current thermal certification.] → PIVOT[obey the R2 mission envelope rather than prove loyalty through maximum fire.] → DELTA[one hostile ship disabled and one carrier rescued; ship agreement works under fire.] → COST[three raider ships escape the first intercept; officers who favored recommission blame the charter limit.] → NEXT[an armed salvage craft attaches to a depot fuel barge and claims emergency recovery rights.]

**HUMAN_PRESSURE_CARRIER**  
source POV/current participants: Rami, Kev, weapons teams and Leda.
**HUMAN_ROUTE_AUTHORITY:** `SOURCE-POV`
...
**POV_INFORMATION_ROUTE**  
Oren Roman, Maren Dove, Neutral rescue and depot workers.
**POV_ROUTE_AUTHORITY:** `SOURCE-EXPLICIT`
...
**SCENE_CAUSAL_CHAIN**  
PRESSURE[stop the attached salvage craft without detonating the barge or turning recovery law into a free capture license.] → OBSTACLE[the craft transmits a valid distress/recovery code while carrying armed boarders and a forced tow line.] → PIVOT[separate rescue obligation from title/salvage transfer and avoid destruction.] → DELTA[42 barge crew survive; the salvage craft is immobilized as evidence, not awarded as prize.] → COST[the barge’s exposed cargo burns during recovery; title and victim claims remain.] → NEXT[depot damage count shows the battle is being won tactically but lost in fuel and medical stock.]

**HUMAN_PRESSURE_CARRIER**  
source POV/current participants: Oren Roman, Maren Dove, Neutral rescue and depot workers.
**HUMAN_ROUTE_AUTHORITY:** `SOURCE-POV`
...
**POV_INFORMATION_ROUTE**  
Haren, Mia, casualty/repair/pay teams and current families.
**POV_ROUTE_AUTHORITY:** `SOURCE-EXPLICIT`
...
**SCENE_CAUSAL_CHAIN**  
PRESSURE[publish the immediate human/material state before command factions rewrite the result.] → OBSTACLE[current source-supported obstacle/pressure encoded in the physical state and cost] → PIVOT[publish range-based counterfactual and multi-cause record instead of declaring charter victory or failure.] → DELTA[current losses cannot be reset or monopolized by one command narrative.] → COST[central-command advocates gain legitimate support; some provincial ships suspend further participation.] → NEXT[Ardo demands a default battle commander for the next alert.]

**HUMAN_PRESSURE_CARRIER**  
source POV/current participants: Haren, Mia, casualty/repair/pay teams and current families.
**HUMAN_ROUTE_AUTHORITY:** `SOURCE-POV`
...
**POV_INFORMATION_ROUTE**  
Ardo, Dor staff, Sira, Rian and affected captains.
**POV_ROUTE_AUTHORITY:** `SOURCE-EXPLICIT`
...
**SCENE_CAUSAL_CHAIN**  
PRESSURE[compare actual shared response with a credible unified-command plan.] → OBSTACLE[the comparison can become ideological propaganda unless assumptions are equal.] → PIVOT[draft a standing defensive intent plus alert-specific default formation sequence rather than universal admiralty.] → DELTA[central speed benefit is preserved as design input.] → COST[formations disagree on who may hold default command and when it ends.] → NEXT[a new alert arrives while the rule is still unsigned.]

**HUMAN_PRESSURE_CARRIER**  
source POV/current participants: Ardo, Dor staff, Sira, Rian and affected captains.
**HUMAN_ROUTE_AUTHORITY:** `SOURCE-POV`
...
**POV_INFORMATION_ROUTE**  
formation commanders, captains and isolated units.
**POV_ROUTE_AUTHORITY:** `SOURCE-EXPLICIT`
...
**SCENE_CAUSAL_CHAIN**  
PRESSURE[survive a smaller second probe while testing standing defensive intent without a complete new charter.] → OBSTACLE[repeating the previous delay could collapse participation; overcorrecting could create de facto Ardo/Rian ownership.] → PIVOT[preserve distributed formation decisions and record the nonparticipating ship as lawful, not cowardly.] → DELTA[`Standing Defensive Intent v0.1` proves usable under communications uncertainty.] → COST[response remains slower than Ardo’s ideal and depends on preagreed objective clarity; no offensive chase occurs.] → NEXT[mandate renewal now requires a broader charter covering command, crew, support, authentication and audit beyond one alert.]

**HUMAN_PRESSURE_CARRIER**  
source POV/current participants: formation commanders, captains and isolated units.
**HUMAN_ROUTE_AUTHORITY:** `SOURCE-POV`
...
**POV_INFORMATION_ROUTE**  
Rian, Ardo Rev, Sira Keon, Oren Roman, Tav Oren, Messa Rin and captains.
**POV_ROUTE_AUTHORITY:** `SOURCE-EXPLICIT`
...
**SCENE_CAUSAL_CHAIN**  
PRESSURE[determine what authority a ship or formation can lend for the next mission without transferring ownership.] → OBSTACLE[every negotiator uses “command” to mean a different bundle: objective, battle order, discipline, weapons, route, support or political allegiance.] → PIVOT[use the principle `command is lent for a mission` and forbid title/pay/root-key transfer through mission acceptance.] → DELTA[the charter’s object becomes a named mission authority rather than a new navy.] → COST[no agreement yet on emergency default, recall or support priority; two formations leave the table as observers.] → NEXT[Dor offers Rian a broader temporary task command if he accepts General Staff default authority.]

**HUMAN_PRESSURE_CARRIER**  
source POV/current participants: Rian, Ardo Rev, Sira Keon, Oren Roman, Tav Oren, Messa Rin and captains.
**HUMAN_ROUTE_AUTHORITY:** `SOURCE-POV`
...
**POV_INFORMATION_ROUTE**  
Rian, Dor Kein, Ardo and Maren Dove.
**POV_ROUTE_AUTHORITY:** `SOURCE-EXPLICIT`
...
**SCENE_CAUSAL_CHAIN**  
PRESSURE[decide whether Rian should accept a broader command that can prevent another thirteen-minute delay.] → OBSTACLE[the offer is operationally credible and popular after the losses; refusing it may cost lives.] → PIVOT[take bounded operational responsibility without accepting default ownership-like allocation power.] → DELTA[Rian receives a defined 6-combat/5-support route group appointment for the next mission-planning phase.] → COST[broader task command remains with Ardo/Dor-aligned proposal; critics argue Rian avoided responsibility.] → NEXT[Charter drafters discover no shared rule for who pays and repairs a ship damaged under borrowed command.]

**HUMAN_PRESSURE_CARRIER**  
source POV/current participants: Rian, Dor Kein, Ardo and Maren Dove.
**HUMAN_ROUTE_AUTHORITY:** `SOURCE-POV`
...
**POV_INFORMATION_ROUTE**  
Haren, Tav, Messa, casualty/family representatives and formation quartermasters.
**POV_ROUTE_AUTHORITY:** `SOURCE-EXPLICIT`
...
**SCENE_CAUSAL_CHAIN**  
PRESSURE[complete a Charter v0.1 draft that assigns command without hiding costs.] → OBSTACLE[formations will lend ships only if loss, repair, pay, family and ammunition debts are recognized; no actor can fund all guarantees.] → PIVOT[publish and carry a visibly incomplete Charter v0.1 draft rather than hide unfunded obligations or declare a finished fleet.] → DELTA[ten executable core clauses and a shared debt/loss record exist.] → COST[Charter is not enacted; family, repair, recall and surrender systems remain open; several ships condition future participation.] → NEXT[a mobile repair/pay convoy is located under disputed claim, and the unfinished Charter cannot yet decide who protects or owns it.]

**HUMAN_PRESSURE_CARRIER**  
source POV/current participants: Haren, Tav, Messa, casualty/family representatives and formation quartermasters.
**HUMAN_ROUTE_AUTHORITY:** `SOURCE-POV`
...
**MYSTERY_INFORMATION_CEILING**  
May expose only this source-supported information now: the lien is genuine for 21% of certified components and two software service packages; it does not title the hull, workers, payroll cargo or mission.. Locked mystery/payoff ledgers outrank lower card tags and this overlay.
...
**MYSTERY_INFORMATION_CEILING**  
May expose only this source-supported information now: 7 ships meet physical mission requirements but 3,420 current crew/family records on those ships remain disputed or unpaid.. Locked mystery/payoff ledgers outrank lower card tags and this overlay.
...
**POV_INFORMATION_ROUTE**  
Kev Raon, loaders, captain and Ardo staff.
**POV_ROUTE_AUTHORITY:** `SOURCE-EXPLICIT`
...
**SCENE_CAUSAL_CHAIN**  
PRESSURE[determine whether the loading refusal is political obstruction or a valid safety action.] → OBSTACLE[current source-supported obstacle/pressure encoded in the physical state and cost] → PIVOT[recognize a six-hour legal work slowdown, isolate the lots and load only verified units.] → DELTA[recognize a six-hour legal work slowdown, isolate the lots and load only verified units.] → COST[42 units remain quarantined; a hostile scout group escapes the preferred intercept window; Ardo’s response plan loses one escort.] → NEXT[a distress transmission arrives from three armed ships previously associated with the recovery/raider force.]

**HUMAN_PRESSURE_CARRIER**  
source POV/current participants: Kev Raon, loaders, captain and Ardo staff.
**HUMAN_ROUTE_AUTHORITY:** `SOURCE-POV`
...
**MYSTERY_INFORMATION_CEILING**  
May expose only this source-supported information now: humidity/charge-seal contamination affects 210 missile/countermeasure units across two lots; immediate full loading creates a credible magazine/launch fault.. Locked mystery/payoff ledgers outrank lower card tags and this overlay.
...
**DECISION_BEAT**  
NON-DISCRETE CAUSAL PIVOT — the approved episode turns on this source state/action result rather than a newly invented choice: people gain plural current paths.
...
**DECISION_BEAT**  
NON-DISCRETE CAUSAL PIVOT — the approved episode turns on this source state/action result rather than a newly invented choice: surrendered/disputed people and ships can enter lawful processes without becoming collected property.
**DECISION_MODE:** `WORKFLOW-NON-DISCRETE PIVOT FROM APPROVED STATE CHANGE`
...
**MYSTERY_INFORMATION_CEILING**  
May expose only this source-supported information now: all three recall chains are authentic; home threats differ in severity; Charter v0.1-R has no complete recall-cost framework.. Locked mystery/payoff ledgers outrank lower card tags and this overlay.
...
**SCENE_CAUSAL_CHAIN**  
PRESSURE[decide whether Doan remains as a celebrated Charter navigator or exercises the home obligation preserved since E467.] → OBSTACLE[current source-supported obstacle/pressure encoded in the physical state and cost] → PIVOT[Doan returns with a lawfully departing provincial ship after handover; leaves current route notes and training but refuses a new Charter oath.] → DELTA[Doan returns with a lawfully departing provincial ship after handover; leaves current route notes and training but refuses a new Charter oath.] → COST[Rian’s task group loses current local-route expertise; public narrative accuses Doan of abandoning the fleet.] → NEXT[one recalled formation’s home emergency is exaggerated to gain bargaining leverage.]

**HUMAN_PRESSURE_CARRIER**  
source POV/current participants: Doan Mir.
**HUMAN_ROUTE_AUTHORITY:** `SOURCE-POV`
...
**MYSTERY_INFORMATION_CEILING**  
May expose only this source-supported information now: one province overstated projected attack probability but has real food/family and patrol shortages.. Locked mystery/payoff ledgers outrank lower card tags and this overlay.
...
**DECISION_BEAT**  
NON-DISCRETE CAUSAL PIVOT — the approved episode turns on this source state/action result rather than a newly invented choice: ships can leave without mutiny/war, and remaining obligations are executable.
**DECISION_MODE:** `WORKFLOW-NON-DISCRETE PIVOT FROM APPROVED STATE CHANGE`
...
**PRIMARY_DECISION_OWNER**  
source decision performer/authority actor(s): Oren
**OWNER_ROUTE_AUTHORITY:** `SOURCE-DECISION-PERFORMER + SOURCE DECISION`
...
**SCENE_CAUSAL_CHAIN**  
PRESSURE[keep the civilian/service convoy intact rather than answer a simultaneous Vesper outer alert.] → OBSTACLE[current source-supported obstacle/pressure encoded in the physical state and cost] → PIVOT[Oren retains all six escorts on the convoy and refuses to detach toward Vesper; he records the choice as his own current command responsibility.] → DELTA[Oren retains all six escorts on the convoy and refuses to detach toward Vesper; he records the choice as his own current command responsibility.] → COST[Vesper outer picket fights with reduced support; Oren’s legitimacy becomes contested by military blocs.] → NEXT[hostile drones drive one escort into a service ship’s thermal wake.]

**HUMAN_PRESSURE_CARRIER**  
source POV/current participants: Oren Roman.
**HUMAN_ROUTE_AUTHORITY:** `SOURCE-POV`
...
**DECISION_BEAT**  
Oren controls escort geometry; civilian captains follow standing dispersal routes; Rian’s limited route element provides current navigation/courier support but does not command Oren; 07 assists exterior rescue/debris marking.
**DECISION_MODE:** `SOURCE-EXPLICIT-DECISION`
...
**MYSTERY_INFORMATION_CEILING**  
May expose only this source-supported information now: the Crown convoy draw was a material contributing factor, not the sole cause; prior recalls and tender/repair limits also mattered.. Locked mystery/payoff ledgers outrank lower card tags and this overlay.
...
**POV_INFORMATION_ROUTE**  
close-third/current-information through front-stage actor: `아셀 바론 / Asel Varon`; code `OFC-001`; commander of the Outer Front Eighth Screen and locally recognized emergency defense administration.
**POV_ROUTE_AUTHORITY:** `WORKFLOW-RECOMMENDATION FROM SOURCE FRONT-STAGE`
...
**OWNER_ROUTE_AUTHORITY:** `SOURCE-FRONT-STAGE`
...
**SCENE_CAUSAL_CHAIN**  
PRESSURE[respond to Asel’s demand for relief, supplies and recognition without transferring Outer Front sovereignty or subordinating the Charter.] → OBSTACLE[Vesper cannot provide the full request after recalls, tender damage and Crown mission losses; Ardo sees a credible military partner but wants common battle succession … [source continues]] → PIVOT[accept fact-finding and negotiate a smaller mission package rather than recognize or reject Asel by future label.] → DELTA[no ships or supplies transfer yet; shared physical/threat data begins; Asel permits one Neutral/Charter survey team under local escort; Rian is not named overall commander.] → COST[Asel publicly states that Vesper protected Crown Passage while the Outer Front lost patrol coverage; local opinion turns against Core/Charter priorities.] → NEXT[survey data shows the Outer Front threat and Orpheus Approach civilian movement are already beginning to converge.]

**HUMAN_PRESSURE_CARRIER**  
front-stage actor: `아셀 바론 / Asel Varon`; code `OFC-001`; commander of the Outer Front Eighth Screen and locally recognized emergency defense administration.
**HUMAN_ROUTE_AUTHORITY:** `SOURCE-FRONT-STAGE`
...
**MYSTERY_INFORMATION_CEILING**  
May expose only this source-supported information now: threat is real; some claimed debts are genuine but do not authorize armed route seizure or person/cargo ownership.. Locked mystery/payoff ledgers outrank lower card tags and this overlay.
...
**SCENE_CAUSAL_CHAIN**  
PRESSURE[choose between rescuing the isolated corvette/hospital tug and pursuing the Recovery Column command ship.] → OBSTACLE[current source-supported obstacle/pressure encoded in the physical state and cost] → PIVOT[Asel abandons the pursuit and commits his reserve to rescue/power-route defense.] → DELTA[hospital tug and 2,480 patients/crew/service users remain supplied; isolated corvette survives but is disabled 9–13 months; threat command ship escapes.] → COST[one Outer Front corvette campaign loss; local hardliners accuse him of protecting civilians at strategic cost.] → NEXT[Recovery Column turns toward the 15-ship civilian/service convoy.]

**HUMAN_PRESSURE_CARRIER**  
source POV/current participants: Asel.
**HUMAN_ROUTE_AUTHORITY:** `SOURCE-POV`
...
**DECISION_BEAT**  
NON-DISCRETE CAUSAL PIVOT — the approved episode turns on this source state/action result rather than a newly invented choice: G5-F04 Outer Front Cooperation becomes conditional/operational.
**DECISION_MODE:** `WORKFLOW-NON-DISCRETE PIVOT FROM APPROVED STATE CHANGE`
...
**DECISION_BEAT**  
NON-DISCRETE CAUSAL PIVOT — the approved episode turns on this source state/action result rather than a newly invented choice: a larger campaign envelope becomes possible.
**DECISION_MODE:** `WORKFLOW-NON-DISCRETE PIVOT FROM APPROVED STATE CHANGE`
...
**DECISION_BEAT**  
NON-DISCRETE CAUSAL PIVOT — the approved episode turns on this source state/action result rather than a newly invented choice: Charter v0.2 becomes operational and Act 5C closes.
**DECISION_MODE:** `WORKFLOW-NON-DISCRETE PIVOT FROM APPROVED STATE CHANGE`
...
**SCENE_CAUSAL_CHAIN**  
PRESSURE[prevent seizure of V09 service anchor and hospital-power route while isolated from Charter command.] → OBSTACLE[current source-supported obstacle/pressure encoded in the physical state and cost] → PIVOT[Lio/current operators confirm inhabited loads and refuse the false evacuation; Asel shifts two escorts from pursuit to a concealed service-anchor defense; local worker tugs cut an armed recovery bridge … [source continues]] → DELTA[4 hostile ships disabled/captured/sealed; 3 withdraw; V09 service anchor and hospital route remain active; 620,000 directly exposed users avoid power/service interruption … [source continues]] → COST[Asel spends 31% of his campaign countermeasure reserve and cannot reinforce another front immediately.] → NEXT[Vesper and Civilian Chain both request the same two-combat/four-support reserve.]

**HUMAN_PRESSURE_CARRIER**  
source POV/current participants: Asel Varon and Lio Saren.
**HUMAN_ROUTE_AUTHORITY:** `SOURCE-POV`
...
**POV_INFORMATION_ROUTE**  
Sira Keon and provincial captains.
**POV_ROUTE_AUTHORITY:** `SOURCE-EXPLICIT`

**PRIMARY_DECISION_OWNER**  
source decision performer/authority actor(s): Sira
**OWNER_ROUTE_AUTHORITY:** `SOURCE-DECISION-PERFORMER + SOURCE DECISION`
...
**SCENE_CAUSAL_CHAIN**  
PRESSURE[decide whether to pursue a hostile scout group or protect a food/guardianship convoy through V07.] → OBSTACLE[current source-supported obstacle/pressure encoded in the physical state and cost] → PIVOT[Sira rejects pursuit and uses her formation to cover the convoy and verify the home alert before recall.] → DELTA[all 12,600 people and 3,800 t arrive; one provincial escort damaged 3–5 months; four injured, none serious; no death; scout group escapes with route observations.] → COST[threat reconnaissance survives; provincial critics accuse Sira of avoiding decisive combat.] → NEXT[Vesper relay jamming turns into an armed attempt to seize repair-traffic authentication.]

**HUMAN_PRESSURE_CARRIER**  
source POV/current participants: Sira Keon and provincial captains.
**HUMAN_ROUTE_AUTHORITY:** `SOURCE-POV`
...
**SCENE_CAUSAL_CHAIN**  
PRESSURE[preserve relay/repair traffic without the held reserve.] → OBSTACLE[current source-supported obstacle/pressure encoded in the physical state and cost] → PIVOT[Ardo uses the arriving 1 combat +2 support reserve as rear rescue/repair cover and commits his own high-readiness ships to a short centralized intercept.] → DELTA[relay remains operational at 82% current capacity; two hostile ships disabled, three withdraw; one Charter combat ship damaged 6–9 months; six injured, one serious; no death … [source continues]] → COST[Vesper cannot send further reinforcement; repair traffic operates with delay and reduced redundancy.] → NEXT[Rian’s Grey Route front finds the route used to feed both the V10 attackers and Recovery Column remnants.]

**HUMAN_PRESSURE_CARRIER**  
source POV/current participants: Ardo Rev and Vesper formation.
**HUMAN_ROUTE_AUTHORITY:** `SOURCE-POV`
...
**POV_INFORMATION_ROUTE**  
Rian, Grey Route captains and local operators.
**POV_ROUTE_AUTHORITY:** `SOURCE-EXPLICIT`
...
**SCENE_CAUSAL_CHAIN**  
PRESSURE[cut hostile reinforcement through V11 without closing rescue/civilian access or claiming theater command.] → OBSTACLE[current source-supported obstacle/pressure encoded in the physical state and cost] → PIVOT[close two armed transit vectors, preserve one verified rescue/service corridor and mark physical/courier challenges for allied fronts.] → DELTA[hostile reinforcement arrival slows 14–19 hours; one Charter support ship damaged 2–4 months during relay capture; three injured, none serious; no death … [source continues]] → COST[the same closure delays friendly medical/ammunition transfers by 6–11 hours.] → NEXT[V10’s contact resolves into 12 armed ships, 26 drones and boarding craft converging on the 18-ship civilian/service group.]

**HUMAN_PRESSURE_CARRIER**  
source POV/current participants: Rian, Grey Route captains and local operators.
**HUMAN_ROUTE_AUTHORITY:** `SOURCE-POV`
...
**MYSTERY_INFORMATION_CEILING**  
May expose only this source-supported information now: threat is 12 armed ships, not the modeled 7–9; one route relay is already compromised; V10 has 0.7 major-action ammunition and no alternate route within 21 hours.. Locked mystery/payoff ledgers outrank lower card tags and this overlay.
...
**POV_INFORMATION_ROUTE**  
Sela Ruk, Crown Guard operations/evacuation officer.
**POV_ROUTE_AUTHORITY:** `SOURCE-EXPLICIT`
...
**SCENE_CAUSAL_CHAIN**  
PRESSURE[correct the forged return order while Oren’s combat screen is engaged.] → OBSTACLE[current source-supported obstacle/pressure encoded in the physical state and cost] → PIVOT[Sela invokes standing civilian-protection authority, splits the convoy into medical/family, service-cargo and high-thrust groups, and assigns local captains direct route choice within the evacuation envelope.] → DELTA[Sela invokes standing civilian-protection authority, splits the convoy into medical/family, service-cargo and high-thrust groups, and assigns local captains direct route choice within the ev … [source continues]] → COST[four slower ships and rear escorts remain exposed; coordination is harder and some families/services are separated temporarily.] → NEXT[attackers disable the V10 relay and isolate the rear group.]

**HUMAN_PRESSURE_CARRIER**  
source POV/current participants: Sela Ruk, Crown Guard operations/evacuation officer.
**HUMAN_ROUTE_AUTHORITY:** `SOURCE-POV`
...
**POV_INFORMATION_ROUTE**  
WORKFLOW POV recommendation — select the already-present human/work carrier identified below, prefer the actor who physically performs/refuses the source pivot or bears its immediate cost, and reveal only information available through that current role: writer face target — use an already-present performer/refuser/recipient from this episode's bounded decision domain (source decision performer/authority actor(s): Oren); ground that face in the exact source pivot [Oren holds the primary combat screen; Sela/local captains continue physical/courier evacuation; one Crown/Charter escort uses itself to break a boarding corridor; a service ship begins catastrophic pressure/fire loss.] and source cost [irreversible human, hull and route-service loss.]. Do not create a new named witness merely to supply emotion.
**POV_ROUTE_AUTHORITY:** `WORKFLOW-RECOMMENDATION FROM SOURCE/BOUNDED EXISTING ROLE — NOT STORY CANON`
...
**DECISION_BEAT**  
Oren holds the primary combat screen; Sela/local captains continue physical/courier evacuation; one Crown/Charter escort uses itself to break a boarding corridor; a service ship begins catastrophic pressure/fire loss.
**DECISION_MODE:** `SOURCE-EXPLICIT-DECISION`
...
**DECISION_BEAT**  
Asel closes V09 approach to protect hospital/service and trap armed transit; Sira closes a provincial fork while preserving one food/return corridor; Rian’s Grey Route front closes the verified armed vector and keeps rescue access; Ardo holds Vesper rather than abandon depot defense for pursuit.
...
**DECISION_BEAT**  
Sira drives the group from Provincial Fork; Rian’s route group denies Grey Route transfer; Asel cuts local service-anchor cover; Ardo’s long-range formation executes the final intercept inside its current lane; Oren/Sela remain with V10 survivors and do not join the pursuit.
**DECISION_MODE:** `SOURCE-BLOCK-DECISION`
...
**DECISION_BEAT**  
NON-DISCRETE CAUSAL PIVOT — the approved episode turns on this source state/action result rather than a newly invented choice: distributed campaign succeeds and preserves autonomous formation legitimacy.
**DECISION_MODE:** `WORKFLOW-NON-DISCRETE PIVOT FROM APPROVED STATE CHANGE`
...
**DECISION_BEAT**  
NON-DISCRETE CAUSAL PIVOT — the approved episode turns on this source state/action result rather than a newly invented choice: Charter v1.0 is ready to become operational.
**DECISION_MODE:** `WORKFLOW-NON-DISCRETE PIVOT FROM APPROVED STATE CHANGE`
...
**DECISION_BEAT**  
NON-DISCRETE CAUSAL PIVOT — the approved episode turns on this source state/action result rather than a newly invented choice: ownerless fleet network and Charter v1.0.
**DECISION_MODE:** `WORKFLOW-NON-DISCRETE PIVOT FROM APPROVED STATE CHANGE`
