# GA10 Collection Desire / Set / Subact Execution Map v1
...
- `SOURCE_SUBACT`: `docs/10_story_architecture/ga10-episodes-1001-1100-act-map-v1.md` / 10A-1
...
- `SYNERGY_OR_USE`: local authority accepts external audit/affected standing and removes/limits one captured official/system. P-001 transfers tools/knowledge rather than personally remain operator.
- `COST_REFUSAL_OR_LOSS`: local autonomy compromised by shared obligations; central residual support remains necessary.
- `SET_ADVANCE_CONDITION`: local authority accepts external audit/affected standing and removes/limits one captured official/system. P-001 transfers tools/knowledge rather than personally remain operator.
...
- `SYNERGY_OR_USE`: A-001/transition officials reveal or withhold a critical dependency; consequence follows.
- `COST_REFUSAL_OR_LOSS`: security incidents, market/political panic and bargaining.
- `SET_ADVANCE_CONDITION`: A-001/transition officials reveal or withhold a critical dependency; consequence follows.
...
- `ACQUISITION_OR_CONNECTION`: Transition Convention and first region-specific compacts.
...
- `SYNERGY_OR_USE`: legitimate delayed path and beneficiary trust.
- `COST_REFUSAL_OR_LOSS`: central authority persists and may resist expiration.
- `SET_ADVANCE_CONDITION`: legitimate delayed path and beneficiary trust.
...
- `SYNERGY_OR_USE`: proves distributed order can correct local abuse through external standing/obligations.
- `COST_REFUSAL_OR_LOSS`: violence/service loss and criticism of hidden centralism.
- `SET_ADVANCE_CONDITION`: proves distributed order can correct local abuse through external standing/obligations.
...
- `SYNERGY_OR_USE`: reciprocal recognition, multiple certifiers, incident disclosure, reserve support and manual fallback.
- `COST_REFUSAL_OR_LOSS`: lower performance, one accident/treatment failure and continuing inequality.
- `SET_ADVANCE_CONDITION`: reciprocal recognition, multiple certifiers, incident disclosure, reserve support and manual fallback.
...
- `SYNERGY_OR_USE`: final transition operation and delegated authority.
- `COST_REFUSAL_OR_LOSS`: political conflict and known exposure.
- `SET_ADVANCE_CONDITION`: final transition operation and delegated authority.
...
- `SYNERGY_OR_USE`: military monopoly and central command expire/fragment according to mandate.
- `COST_REFUSAL_OR_LOSS`: casualties, service loss and P-001 no longer able to retake all control instantly.
- `SET_ADVANCE_CONDITION`: military monopoly and central command expire/fragment according to mandate.
...
- `ACQUISITION_OR_CONNECTION`: no single sovereign Seed operator; plural systems remain connected.
