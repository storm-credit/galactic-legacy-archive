# GA1 Collection Desire / Set / Subact Execution Map v1
...
- `ACTIVE_TARGETS`:
  ...
  - `CLT-GA1-R-004` / `R-004` / Neutral Medical Protection Clause — `EPISODE_OVERLAP+TITLE_TEXT` score=114
  - `CLT-GA1-P-009` / `P-009` / R-HEL-001 / Helix Evaluator — `EPISODE_OVERLAP+DOMAIN_MATCH` score=110
  - `CLT-GA1-F-005` / `F-005` / Mixed Leg Pair — `EPISODE_OVERLAP+DOMAIN_MATCH` score=110
  - `CLT-GA1-R-007` / `R-007` / H-002 Maintenance and Design-Rights Agreement — `EPISODE_OVERLAP+DOMAIN_MATCH` score=110
- `SOURCE_SUBACT`: `docs/10_story_architecture/first-100-act-map-v2-consolidated.md` / B1
- `NEW_CANON_REQUIRED`: `NO`
...
- `ACTIVE_TARGETS`:
  ...
  - `CLT-GA1-P-003` / `P-003` / S-001 / Data and Audit Cadet — `EPISODE_OVERLAP+TITLE_TEXT+DOMAIN_MATCH` score=118
  - `CLT-GA1-I-001` / `I-001` / Student Mutual Network / Assembly Seed — `EPISODE_OVERLAP+TITLE_TEXT+DOMAIN_MATCH` score=118
  - `CLT-GA1-P-005` / `P-005` / I-001 / Field Instructor — `EPISODE_OVERLAP+DOMAIN_MATCH` score=110
  - `CLT-GA1-P-009` / `P-009` / R-HEL-001 / Helix Evaluator — `EPISODE_OVERLAP+DOMAIN_MATCH` score=110
- `SOURCE_SUBACT`: `docs/10_story_architecture/first-100-act-map-v2-consolidated.md` / B2
- `NEW_CANON_REQUIRED`: `NO`
...
- `ACTIVE_TARGETS`:
  ...
  - `CLT-GA1-P-004` / `P-004` / M-001 / Medical and Rescue Cadet — `EPISODE_OVERLAP` score=101
- `SOURCE_SUBACT`: `docs/10_story_architecture/first-100-act-map-v2-consolidated.md` / C1
- `NEW_CANON_REQUIRED`: `NO`
...
- `ACTIVE_TARGETS`:
  ...
  - `CLT-GA1-I-003` / `I-003` / Multi-Party Medical Oversight — `EPISODE_OVERLAP+TITLE_TEXT` score=111
  - `CLT-GA1-F-013` / `F-013` / Service Authority Key C — `EPISODE_OVERLAP` score=101
- `SOURCE_SUBACT`: `docs/10_story_architecture/first-100-act-map-v2-consolidated.md` / C2
- `NEW_CANON_REQUIRED`: `NO`
...
- `ACTIVE_TARGETS`:
  ...
  - `CLT-GA1-I-003` / `I-003` / Multi-Party Medical Oversight — `EPISODE_OVERLAP+TITLE_TEXT+DOMAIN_MATCH` score=119
- `SOURCE_SUBACT`: `docs/10_story_architecture/first-100-act-map-v2-consolidated.md` / C4
- `NEW_CANON_REQUIRED`: `NO`
...
- `ACTIVE_TARGETS`:
  ...
  - `CLT-GA1-I-001` / `I-001` / Student Mutual Network / Assembly Seed — `EPISODE_OVERLAP+TITLE_TEXT+DOMAIN_MATCH` score=114
- `SOURCE_SUBACT`: `docs/10_story_architecture/first-100-act-map-v2-consolidated.md` / D1
- `NEW_CANON_REQUIRED`: `NO`
...
- `ACTIVE_TARGETS`:
  ...
  - `CLT-GA1-I-001` / `I-001` / Student Mutual Network / Assembly Seed — `EPISODE_OVERLAP+DOMAIN_MATCH` score=110
  - `CLT-GA1-R-011` / `R-011` / 제13학원 임시공동운영·보호헌장 — `EPISODE_OVERLAP+DOMAIN_MATCH` score=105
- `SOURCE_SUBACT`: `docs/10_story_architecture/first-100-act-map-v2-consolidated.md` / D2
- `NEW_CANON_REQUIRED`: `NO`
